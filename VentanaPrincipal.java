...
public class VentanaPrincipal extends javax.swing.JFrame implements MouseListener{
    ...
    int arregloNumeroImagenes[]=new int[12];//Arreglo que contendra el numero correspondiente al nombre de las imagenes
    JLabel arregloLabelImagenes[]=new JLabel[12];//Arreglo con los componentes JLabel donde se pintan las imagenes
    int arregloControlRepeticiones[]=new int[6];//Arreglo que evitara que un numero se repita mas de 2 veces
    int arregloControlParejas[]=new int[12];//Arreglo que permitira llevar el control de las parejas encontradas
    int arregloCantClic[]=new int[12];//Arreglo que permitira controlar los eventos producidos cada que se de clic en una imagen
	
    int clic=0;//Variable que determinara cuantos clic se han dado antes de validar las parejas
    int vista1,vista2;//variables que indicaran cuales son las imagenes que se han mostrado
    int puntaje=0;//Variable que permitira llevar un conteo de los puntos 
    ...
    private void initComponents() {
        ...
        lblPuntos.setFont(new java.awt.Font("Tahoma", 0, 80));
        ...
        etiImagen1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg"))); 
        etiImagen1.setBounds(5, 0, 100, 100);
       
        etiImagen2 = new JLabel();
        etiImagen2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg"))); 
        etiImagen2.setBounds(113, 0, 100, 100);

        etiImagen3 = new JLabel();
        etiImagen3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen3.setBounds(220, 0, 100, 100);

        etiImagen4 = new JLabel();
        etiImagen4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen4.setBounds(5, 100, 100, 100);

        etiImagen5 = new JLabel();
        etiImagen5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen5.setBounds(113, 100, 100, 100);

        etiImagen6 = new JLabel();
        etiImagen6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen6.setBounds(220, 100, 100, 100);

        etiImagen7 = new JLabel();
        etiImagen7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen7.setBounds(5, 200, 100, 100);

        etiImagen8 = new JLabel();
        etiImagen8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen8.setBounds(113, 200, 100, 100);

        etiImagen9 = new JLabel();
        etiImagen9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg"))); 
        etiImagen9.setBounds(220, 200, 100, 100);

        etiImagen10 = new JLabel();
        etiImagen10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg"))); 
        etiImagen10.setBounds(5, 300, 100, 100);

        etiImagen11 = new JLabel();
        etiImagen11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen11.setBounds(113, 300, 100, 100);
        
        etiImagen12 = new JLabel();
        etiImagen12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/quien.jpg")));
        etiImagen12.setBounds(220, 300, 100, 100);

        panelImagenes = new JPanel();
        panelImagenes.setBackground(new java.awt.Color(153, 163, 164 ));
        ...
        panelSuperior.setBackground(new java.awt.Color(40, 53, 147 ));
        panelSuperior.add(etiquetaTitulo);
        
        panelInfo = new JPanel();
        panelInfo.setBackground(new java.awt.Color(106, 27, 154));
        ...
        panelCentral.setBackground(new java.awt.Color(153, 163, 164));
        panelCentral.setLayout(null);
        panelCentral.add(panelImagenes);
        panelCentral.add(panelInfo);
        
        panelInferior = new JPanel();
        panelInferior.setBackground(new java.awt.Color(40, 53, 147));
	...
	//======================================================================================================//
			...
			llenaArreglosConCeros(arregloCantClic);
			 ...
			 int posicionImagen;
			  for (int i = 0; i < 12; i++) {
				 ...
				 posicionImagen=r.nextInt(6);//la posicion de la Imagen tendra un valor aleatorio entre 0 y 5, es decir, 6 valores posibles
	            /*Se valida que el numero aleatorio solo se repita 2 veces*/
	            if(arregloControlRepeticiones[posicionImagen]<2){
	                arregloNumeroImagenes[i]=posicionImagen+1;//almacena el valor que representa cada imagen (la imagen se llama con su numero), se suma 1 porque si el numero es 0 entonces queda en 1
		...
		private void inicializaArregloImagenes() {
			arregloLabelImagenes[0]=etiImagen1;  
			arregloLabelImagenes[1]=etiImagen2;   
			arregloLabelImagenes[2]=etiImagen3;
			arregloLabelImagenes[3]=etiImagen4; 
			 arregloLabelImagenes[4]=etiImagen5;  
			arregloLabelImagenes[5]=etiImagen6;
			arregloLabelImagenes[6]=etiImagen7; 
			arregloLabelImagenes[7]=etiImagen8;  
			arregloLabelImagenes[8]=etiImagen9;
			arregloLabelImagenes[9]=etiImagen10; 
			arregloLabelImagenes[10]=etiImagen11; 
			arregloLabelImagenes[11]=etiImagen12;
	...
	public void mouseClicked(MouseEvent e) {
		...
		for (int i = 0; i < 12; i++) {
			/*Con esta validacion nos damos cuenta de cual label se presion� y validamos que
			...
			if (e.getSource()==arregloLabelImagenes[i] && verificaParejasEncontradas(i)) {
				...
				/*se valida que el mismo label no se presionara mas de dos veces seguidas, si esto es as�
